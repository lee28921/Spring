...
public class AnnotationController {
	...
	public String param3(Model model,String uid, String name, String hp, int age) {
	...
	public String model1(@ModelAttribute("user") ModelDTO dto) {
		
		return "/result/model";
	}
	@PostMapping("/annotation/model2")
	public String model2(@ModelAttribute ModelDTO dto) {
		return "/result/model";
	}
